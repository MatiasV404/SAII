...
class menu(customtkinter.CTk):
    def __init__(self):
        ...
        self.bt_ajustar = CTkButton(self, font = customtkinter.CTkFont('sans rerif', 15), border_color = c_negro, border_width = 3,
        ...
        self.bt_contactos = CTkButton(self, font = customtkinter.CTkFont('sans rerif', 15), border_color = c_negro, border_width = 3,
        ...
        self.bt_historial = CTkButton(self, font = customtkinter.CTkFont('sans rerif', 15), border_color = c_negro, border_width = 3,
        ...
        self.bt_caldiad = CTkButton(self, font = customtkinter.CTkFont('sans rerif', 15), border_color = c_negro, border_width = 3,
